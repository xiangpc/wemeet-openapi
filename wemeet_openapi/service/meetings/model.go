...
type V1MeetingSetWaitingRoomWelcomeMessagePostRequest struct {
    ...
    OperatorIdType float32 `json:"operator_id_type"`
    // 欢迎语，文本类型，最大长度1000字符。欢迎语中如果传入占位符%NICKNAME%（大小写敏感），则该占位符会被替换为被私聊用户的会中昵称。一条消息中支持多个占位符。
...
// V1MeetingsPost200ResponseMeetingInfoListInner struct for V1MeetingsPost200ResponseMeetingInfoListInner
...
// V1MeetingsPost200ResponseMeetingInfoListInnerLiveConfig 直播配置
...
// V1MeetingsPost200ResponseMeetingInfoListInnerSettings 会议媒体参数配置

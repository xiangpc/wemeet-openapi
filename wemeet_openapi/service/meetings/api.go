...
import (
    ...
    core "git.code.tencent.com/open_sdk/openapi-sdk-go/wemeet_openapi/core"
    xhttp "git.code.tencent.com/open_sdk/openapi-sdk-go/wemeet_openapi/core/xhttp"
)

type Service interface {
/*
V1AsrDetailsGet 导出会议转写记录[/v1/asr/details - Get]
...
/*
V1MeetingJobIdGet 获取异步导出任务结果[/v1/meeting/{job_id} - Get]
...
/*
V1MeetingsCustomerShortUrlPost 创建用户专属链接[/v1/meetings/customer-short-url - Post]
...
/*
V1MeetingsGet 通过会议CODE查询会议详情/查询用户的会议列表[/v1/meetings - Get]
...
/*
V1MeetingsMeetingIdEnrollApprovalsPut 审批云会议报名信息[/v1/meetings/{meeting_id}/enroll/approvals - Put]
...
/*
V1MeetingsMeetingIdEnrollIdsPost 查询会议成员报名ID[/v1/meetings/{meeting_id}/enroll/ids - Post]
...
/*
V1MeetingsMeetingIdGet 通过会议ID查询会议列表[/v1/meetings/{meeting_id} - Get]
...
/*
V1MeetingsMeetingIdRealTimeParticipantsGet 查询会议实时信息状态[/v1/meetings/{meeting_id}/real-time-participants - Get]
...
/*
V1PmiMeetingsGet 查询个人PMI会议列表[/v1/pmi-meetings - Get]
